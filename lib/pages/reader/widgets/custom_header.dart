...
}) => physics.SpringDescription.withDampingRatio(mass: 1, stiffness: 500, ratio: 1.1);
...
class _MaterialIndicatorState extends State<_MaterialIndicator> {
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      ...
      children: [
        SizedBox(width: _axis == Axis.vertical ? double.infinity : offset, height: _axis == Axis.horizontal ? double.infinity : offset),
